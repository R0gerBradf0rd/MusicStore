...
{
    public class IncreaseProductInWarehaouseCommandValidator : IAsyncValidator<IncreaseProductInWarehaouseCommand>
    {
        private readonly IProductWarehouseRepository _productWarehouseRepository;

        public IncreaseProductInWarehaouseCommandValidator( IProductWarehouseRepository productWarehouseRepository )
        {
            _productWarehouseRepository = productWarehouseRepository;
        }
        public async Task<Result> ValidateAsync( IncreaseProductInWarehaouseCommand request )
        {
